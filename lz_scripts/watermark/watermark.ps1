...
[Int32]$maxSize = ($minLen - 2*$textMargin) /2
if($charSize -gt $maxSize) {
    $charSize = $maxSize
}
...
$g.FillRectangle([System.Drawing.SolidBrush]::new([System.Drawing.Color]::OrangeRed), 0, $minLen/2-$maxSize, $minLen, $maxSize)
...
$rect = [System.Drawing.RectangleF]::new(0, $minLen/2 - $maxSize, $minLen, $maxSize)
